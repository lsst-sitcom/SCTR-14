...
~\\
See the attached \emph{LSST Rotator Hexapod's Manual} for more
...
Command (0,0,0,0.170deg,-0.170deg,0): {(0,0,0,0.173,-0.1714,0)}\\
~\\
Measurements error STDEV\textless{}0.00205Deg
...
Command (0,0,0,0,0,-0.1deg): {(0,0,0,0,0,-0.09955)}\\
~\\
{}Error \textless{} 0.015Deg
...
can be found linked in the Traceability tab.\\
~\\
See the attached \emph{LSST Rotator Hexapod's Manual} for more
information on how to operate the hexapod.
