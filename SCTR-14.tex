...
shipment from the vendor's facility to the Summit, as defined in \citeds{LTS-206}
and \citeds{LTS-160}.\\
...
verified during the test campaign by the vendor at the vendor's facility
...
\includegraphics[width=3.12500in]{jira_imgs/2057.png}In summary:\\
...
\item
  ...
  workarounds.\\
  Therefore, the corresponding test steps passed with
  deviations.\\[2\baselineskip]
\end{itemize}
...
were only partially tested as needed to conduct the other
...
Recovery needed direct intervention at the issue-causing actuator. The
problem was solved by taking out \textbf{all} actuators and servicing
...
actuators. The drives did not present any obvious failure reason. The
...
The problem did not appear again.\\[2\baselineskip]Apart from the
...
\item
  ...
  3.5.24\_1 Hexapod Absolute Accuracy - LSST
  Re-verification}.\\[2\baselineskip]
\end{itemize}
...
issue was observed for the hexapod's absolute accuracy. The reasons were
lying, most likely in the measurement setup itself. The laser tracker
...
were not performed due to missing time
reasons.\\[2\baselineskip]\textbf{The following results are for the
second
...
origin to avoid possible hysteresis.\\
...
test results.\\[2\baselineskip]The following hardware tests from the
MOOG testing sequence should be included
...
\textbf{The following recommendations are for the situation after the
second test-cycle
\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCycle/LVV-C191}{LVV-C191}:}\\[2\baselineskip]The
hardware-related tests need to be re-executed when the redesign and
reconstruction of the actuator are finished.\\
This involves new hardware and is, therefore, not part of this test plan
for the re-verification of the vendor-delivered
hardware.\\[2\baselineskip]During the test with the new hardware,
including a test over the full range up to the software limits. It must
include the +/- 8.7mm position.
...
vendor's facility to the Summit, as defined in \citeds{LTS-206}.\\
...
\item
  ...
  be loaded with the camera simulated mass or actual camera
...
The test procedure used during the vendor's acceptance testing is the
\emph{LSST Hexapods-Rotator Acceptance Test Procedure} which is attached
to this test case.\\
The test steps of this test case reference the vendor's acceptance test
procedure for the details on how to perform the test.\\
The reference to the vendor's acceptance test procedure is included to
perform the test similarly as it was performed previously.\\
There are also deviations to the vendor's acceptance test procedure
...
Rubin.\\[2\baselineskip]See the attached \emph{LSST Rotator Hexapod's
...
The objective of this test case is to re-verify the functional
requirements of the camera hexapod's software after the shipment of the
...
LSST during the Factory Acceptance Test review.\\
The test procedure used during the vendor's acceptance testing is the
\emph{LSST Hexapods-Rotator Software Acceptance Test Procedure} which is
...
previously. The test steps include changes noted by the
...
\end{tabular}
 Description \\
{\footnotesize
\textbf{STARTING THE EUI}\\[2\baselineskip]Connect to the ``hexrot''-
virtual machine
...
~+/-7.6mm & \textless{}125um & Laser Tracker & \textless{}29um RMS & YES
& & & max. \textless{}119um & YES & ~stdev 36um\tabularnewline
& & & Z & Absolute & ~+/-7.73mm & \textless{}25um & Laser Tracker &
\textless{}31um RMS & YES (Marginal) & L.T. resol. & &
max.\textless{}30um~ & YES (Marginal) & L.T. res.\textasciitilde{}30um
(3 outliers)\tabularnewline
& & Rot & RxRy & Absolute & ~+/-0.17Deg & \textless{}0.00205Deg & Laser
Tracker & \textless{}0.0016Deg RMS & YES & & &
max.\textless{}0.0025{Deg} & YES (Marginal) & 6 outliers (due to
noise)\tabularnewline
& & & Rz & Absolute & 0 & \textless{}0.015Deg & Laser Tracker & Not
checked & ~------ & tbd & & max.\textless{}0.004{Deg} & YES
&\tabularnewline
\bottomrule
\end{longtable}
...
Ordered from tighter to looser specs, based on document LTS-206, {[}1{]}
...
& 0.04 to 0.24 Deg & & & & & & & & &\tabularnewline
& (Y offset measured-expected, due to Rx rotation for a given COR,
should be \textless{}125um) & Trans & Y & & Y=pivot*Rx &
{ΔY}{\textless{}125um} & Laser Tracker & \textless{}35um RMS & YES & & &
max.\textless{}19um & YES &\tabularnewline
\bottomrule
\end{longtable}
...
~0mm & \textless{}125um & Laser Tracker & \textless{}30um & YES & & &
\textless{} 50um & YES &\tabularnewline
& (moves should be reached with inactive axes residuals X and
Y\textless{}125um and Z\textless{}25um) & & Y & Absolute & ~0mm &
\textless{}125um & Laser Tracker & \textless{}50um & YES & & &
\textless{} 17um & YES &\tabularnewline
& (data from the measurements of 3.3.4 and 3.3.8 above) & & Z & Absolute
& ~0mm & \textless{}25um & Laser Tracker & \textless{}27um RMS & YES & &
& \textless{} 13um & YES &\tabularnewline
& & & Rx & Absolute & 0Deg & \textless{}0.00205Deg & Laser Tracker & Not
checked & ~------ & & & max.\textless{}0.0037Deg & Yes (marginal) &
Stdev =0.0020Deg\tabularnewline
& & & Ry & Absolute & 0Deg & \textless{}0.00205Deg & Laser Tracker & Not
checked & ~------ & & & \textless{}0.0017Deg & YES &\tabularnewline
& & & Rz & Absolute & 0Deg & \textless{}0.015Deg & Laser Tracker & Not
checked & ~------ & & & \textless{}0.0049Deg & YES &\tabularnewline
\bottomrule
\end{longtable}

Detailed test data:\\[2\baselineskip]

absolute accuracy cross-talk
...
Hexapod radial XY translational range {(hexapod operation spec) ~ ~ ~ ~
~(LTS-206,~}{3.3.4}{)}
...
\textbackslash{}Detailed data:\\[2\baselineskip]
...
--\textgreater{} passed\\[2\baselineskip]
...
\textless{}25um & Laser Tracker & 0um & YES & from 3.3.13 & &
\textless{} 25um & YES &\tabularnewline
& ({*}{where max. Z range should have been +/-8.7mm)} & & & & & & & & &
& & & &\tabularnewline
\bottomrule
\end{longtable}
...
\begin{longtable}[]{@{}lllllllllllllll@{}}
\toprule
9 & \vtop{\hbox{\strut Hexapod Rotational Rx Ry range {(hexapod
operation spec) ~ ~ ~ ~}}\hbox{\strut {(LTS-206,~}{3.3.8}{)}}} & & RxRy
& Absolute & ~+/-0.24Deg & \textless{}0.00205Deg & Laser Tracker &
\textless{}0.0021Deg & YES & & & \textless{}0.0008 & YES
&\tabularnewline
& (where RxRy=
...
\textless{}0.015Deg & Laser Tracker & Not checked & ~------ & tbd & &
Not checked & ~------ &\tabularnewline
\bottomrule
\end{longtable}
...
(LTS-602,~}{3.3.12}{)} & Trans & Z & Absolute & ~+/-50um &
\textless{}4um & Linear Gauge & \textless{}3um & YES & & &
\textless{}3um & YES &\tabularnewline
& (steps of 50um in translation, tb/reached to \textless{}4xResolution)
& & X & Absolute & ~+/-50um & \textless{}20um & Linear Gauge &
\textless{}3um & YES & & & \textless{}1um & YES &\tabularnewline
& & & Y & Absolute & ~+/-50um & \textless{}20um & Linear Gauge &
\textless{}4um & YES & & & \textless{}4um & YES &\tabularnewline
& (steps of 0.0015Deg in rotation,tb/reached to \textless{}4xResolution)
& Rot & Rx & Absolute & ~+/-0.0015Deg & \textless{}0.000328Deg & Linear
Gauge & \textless{}0.00018Deg & YES & & & \textless{}8.1E-5Deg & YES
&\tabularnewline
& & & Ry & Absolute & ~+/-0.0015Deg & \textless{}0.000328Deg & Linear
Gauge & \textless{}0.00018Deg & YES & & & \textless{}41.0E-5Deg & YES
&\tabularnewline
& & & Rz & Absolute & ~+/-0.0015Deg & \textless{}0.0024Deg & Linear
Gauge & \textless{}0.00026Deg & YES & & & \textless{}44.0E-5Deg & YES
&\tabularnewline
\bottomrule
\end{longtable}
...
\textless{}25um & Laser Tracker & 0um & YES (lucky) & 30um{~x-talk} & &
\textless{} 24um & YES &\tabularnewline
& (steps of 25\%,50\%,75\%,100\% of max range, tb/reached to
\textless{}25xResolution) & & X & Absolute & ~+/-7.6mm &
\textless{}125um & Laser Tracker & \textless{}30um & YES & & &
\textless{} 40um & YES &\tabularnewline
& & & Y & Absolute & ~+/-7.6mm & \textless{}125um & Laser Tracker &
\textless{}120um & YES & & & \textless{} 51um & YES &\tabularnewline
& & Rot & Rx & Absolute & ~+/-0.24Deg & \textless{}0.00205Deg & Laser
Tracker & \textless{}0.0017Deg & YES & & & \textless{} 0.0006Deg & YES &
doing frequent zeroing\tabularnewline
& & & Ry & Absolute & ~+/-0.24Deg & \textless{}0.00205Deg & Laser
Tracker & \textless{}0.0023Deg & YES (Marginal) & & &
\textless{}0.0003Deg & YES & has improved the data\tabularnewline
& & & Rz & Absolute & ~+/-0.1Deg & \textless{}0.015Deg & Laser Tracker &
Not done & ~------ & low{~priority} & & Not done & ~------ & low
priority\tabularnewline
\bottomrule
\end{longtable}
...
various consecutive long moves or many (\textasciitilde{}1500) small
moves to simulate an observing night. --\textgreater{} passed
...
Test Sequence \#1 - Synchronous PositionSet and Move
Commands}\\[2\baselineskip]With the synchronous button enabled and in
enabled/stationary state, send a positionSet command of (2000um,
-3500um, 200um, .01 deg, -.05deg, .002deg) using the EUI.
...
Test Sequence \#4 - Synchronous Offset and Move
Commands}\\[2\baselineskip]With the synchronous button enabled and in
enabled/stationary state, send a move command of (500um, 800um, 200um, 0
deg, 0 deg, 0 deg).
...
Procedure\\
Test Sequence \#5 - Stop Commands}\\[2\baselineskip]In
enabled/stationary state, send a move command of (0um, 0um, 5000um, 0
deg, 0 deg, 0 deg).
